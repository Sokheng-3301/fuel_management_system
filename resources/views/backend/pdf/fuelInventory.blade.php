            ...
            @foreach ($fuels as $key => $item)
                <tr>
                    ...
                    <td class="text">
                        <p>
                            {{ $item->qty ?? '0.00' }}<span
                                class="ps-2"> {{ __('L') }}</span>
                        </p>

                    </td>
                    <td class="text-start"><i
                            class="bi bi-currency-dollar icon"></i>USD {{ $item->unit_price ?? '0.00' }}
                    <td class="text-start"><i
                            class="bi bi-currency-dollar icon"></i>USD {{ $item->total_price ?? '0.00' }}
                    </td>
                    <td class="text-start">
