...
<head>
    ...
    <title>{{ __('Sale Management') }}</title>
    <style>
        * {
            margin: 0 !important;
            padding: 0 !important;
...
<body>
    <h4 class="text-center">{{ __('Sale Management List') }}</h4>
            ...
            @foreach ($sales as $index => $item)
                <tr class="">
                    ...
                    <td class="text ">
                        ...
                        <p class="text-capitalize ">
                            <i
                                class="bi bi-telephone icon "></i>{{ $item->customer->phone }}
                        </p>
                    </td>
                    ...
                    <td class="text ">
                        <p class="text-capitalize">
                            @if ($item->payment_method == '1')
                                <i
                                    class="bi bi-cash-coin icon "></i>
                                {{ __('Cash') }}
                            @elseif ($item->payment_method == '2')
                                <i
                                    class="bi bi-credit-card icon "></i>
                                {{ __('Credit/Debit Cards') }}
                            @elseif ($item->payment_method == '3')
                                <i
                                    class="bi bi-phone icon "></i>
                                {{ __('Mobile Payments') }}
                            @else
                                ($item->payment_method == 'bank_transfer')
                                <i
                                    class="bi bi-bank icon "></i>
                                {{ __('Bank Transfers') }}
                            @endif
                        </p>
                    ...
                    <td class="text ">
                        <p class="">
                            <i
                                class="bi bi-calendar2-week icon "></i>
                        ...
                        <p>
                            <i
                                class="bi bi-person-badge icon "></i>
