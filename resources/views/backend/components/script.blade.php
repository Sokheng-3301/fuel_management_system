<script src="{{ asset('dist/js/overlayscrollbars.browser.es6.min.js') }}"
...
<!-- OPTIONAL SCRIPTS -->
<!-- sortablejs -->
<script src="{{ asset('dist/js/Sortable.min.js') }}" integrity="sha256-ipiJrswvAR4VAx/th+6zWsdeYmVae0iJuiR+6OqHJHQ="
...
<!-- apexcharts -->
<script src="{{ asset('dist/js/apexcharts.min.js') }}" integrity="sha256-+vh8GkaU7C9/wbSLIcwq82tQ2wTf44aOHA8HlBMwRI8="
    crossorigin="anonymous"></script>
<!-- ChartJS -->
<script>
...
<!-- jsvectormap -->
<script src="{{ asset('dist/js/jsvectormap.min.js') }}" integrity="sha256-/t1nN2956BT869E6H4V1dnt0X5pAQHPytli+1nTZm2Y="
    crossorigin="anonymous"></script>
<script src="{{ asset('dist/js/world.js') }}" integrity="sha256-XPpPaZlU8S/HWf7FZLAncLg2SAkP8ScUTII89x9D3lY="
    crossorigin="anonymous"></script>
<!-- jsvectormap -->
<script>
    const visitorsData = {
