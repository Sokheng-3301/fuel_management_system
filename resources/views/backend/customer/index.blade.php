            ...
            <div class="card direct-chat direct-chat-primary mb-4">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="{{ route('customer.create') }}" class="ui button small blue"><i
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            <div class="ui buttons tiny">
                                ...
                                <a href="{{ route('customer.pdf') }}" class="ui button" id="pdfButton"><i
                                        class="bi bi-file-pdf icon"></i>{{ __('PDF') }}</a>
                                <a href="{{ route('customer.excel') }}" class="ui button" id="excelButton"><i
                                    ...
                                    @foreach ($customers as $index => $item)
                                        <tr class="{{ $item->delete_status == 0 ? 'text-danger' : '' }}">
                                            ...
                                            <td
                                                ...
                                                <p>
                                                    <a class="{{ $item->delete_status == 0 ? 'text-danger' : '' }}"
                                            ...
                                            <td
                                                class="text {{ $item->delete_status == 0 ? 'text-danger' : '' }} popup-text-{{ $index + 1 }}">
                                                <p data-tooltip="{{ $item->address }}" data-position="bottom center">
                                                    {{ Str::substr($item->address, 0, 14) }}...
                                                </p>
